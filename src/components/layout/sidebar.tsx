  ...
  return (
    <aside className="glass-nav sticky top-4 m-4 mr-0 hidden h-[calc(100dvh-2rem)] flex-col px-4 py-5 md:flex">
      ...
      <div className="glass-control mt-auto rounded-2xl p-3.5">
        <div className="mb-3 flex items-center gap-2 text-xs text-[#aaaab5]"><span className="grid size-7 place-items-center rounded-lg bg-[#6ee7b7]/10 text-[#6ee7b7]"><Icon name="flame" size={15}/></span>连续专注 18 天</div>
        <div className="h-1.5 overflow-hidden rounded-full bg-white/[0.06]"><div className="h-full w-[72%] rounded-full bg-gradient-to-r from-[#9b87f5] to-[#6ee7b7]"/></div>
        <p className="mt-2 text-[10px] text-[#686875]">再坚持 2 天刷新记录</p>
      </div>
    </aside>
  );
}
